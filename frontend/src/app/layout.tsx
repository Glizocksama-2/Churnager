...
export const metadata = {
  title: "Angaza - Autonomous Churn Intelligence",
      ...
      <body className="antialiased min-h-screen flex flex-col">
        <header className="border-b border-slate-100 bg-white/80 backdrop-blur sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <span className="w-8 h-8 rounded-full bg-accent flex items-center justify-center text-white font-bold">A</span>
              <span className="text-xl font-extrabold tracking-tight text-slate-900">Angaza</span>
            </div>
        ...
        <footer className="border-t border-slate-100 bg-white py-8">
          <div className="max-w-7xl mx-auto px-6 text-center text-xs text-slate-500">
            &copy; {new Date().getFullYear()} Angaza Churn Alert. Built for B2B SaaS.
          </div>
        </footer>
      </body>
    </html>
